function info = cnn_imagenet_evaluate_depth(varargin)
...
opts.expDir = fullfile(expDir,'data', sprintf('Imagenent_Depth-%s', sfx)) ;
opts.imdbPath = fullfile(opts.expDir, 'imdb.mat');
% opts.modelPath = fullfile('data', 'models', 'imagenet-vgg-f.mat') ;
opts.modelPath = fullfile(  'net-deployed.mat') ;

function [net, info] = cnn_imagenet_depth(varargin)
...
opts.dataDir = fullfile('/scratch/cs/imagedb/anwerr1/Datasets/','Imagenet_2012_depth_indoor') ;

%% Experiment directory 
expDir = '/scratch/cs/imagedb/anwerr1/matconvnet/matconvnet-1.0-beta18_gpu/examples/imagenet/';
...
% opts.expDir = fullfile('data', sprintf('exampleimagenet121-%s', sfx)) ;
opts.expDir = fullfile(expDir,'data', sprintf('Imagenent_Depth_gray-%s', sfx)) ;
...
if exist(opts.imdbPath)
  ...
  imdb = cnn_imagenet_setup_data_depth('dataDir', opts.dataDir, 'lite', opts.lite) ;
  mkdir(opts.expDir) ;

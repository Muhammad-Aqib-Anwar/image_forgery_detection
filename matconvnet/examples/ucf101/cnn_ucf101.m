function [net, info] = cnn_ucf101(varargin)
...
expDir = '/triton/ics/project/imagedb/anwerr1/matconvnet-1.0-beta18/examples/ucf101/';

%% 
opts.modelType = 'alexnet' ; %  'alexnet', 'vgg-f','vgg-m','vgg-s','vgg-vd-16','vgg-vd-19'
...
if exist(opts.imdbPath)
  ...
  imdb = cnn_ucf101_setup_data(opts,1) ; %% opts and split_id = 1, 2, 3 splitids 
  mkdir(opts.expDir) ;

function [net, info] = cnn_ucf101_new(varargin)
...
expDir = '/triton/ics/project/imagedb/anwerr1/matconvnet-1.0-beta18_gpu/examples/ucf101/';
...
if exist(opts.imdbPath)
  ...
  imdb = cnn_ucf101_setup_data_new(opts,1) ; %% opts and split_id = 1, 2, 3 splitids 
  mkdir(opts.expDir) ;

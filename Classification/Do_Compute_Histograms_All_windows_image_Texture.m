function tmp_hist=Do_Compute_Histograms_All_windows_image_Texture(rgbImage,mapping5)
% num_levels=3;
num_levels=1;
tmp_hist=[];
[m n p]      = size(rgbImage);
...
for jj=1:num_levels
    ...
    for ll=1:jj
        for kk=1:jj
            ...
            fg=Do_Compute_Histograms_each_window_image_Texture(img_crops,mapping5);

function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2007(opts,classification_opts,rng)
...
% histogram3=normalize(histogram3,1);
...
%            size(histogram)
histogram=[histogram1;histogram4;histogram5];
clear histogram1; clear histogram4; clear histogram5;

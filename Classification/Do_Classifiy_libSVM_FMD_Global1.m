function [svm_score,best_CV]=Do_Classifiy_libSVM_FMD_Global1(opts,classification_opts)
...
%  nimages=opts.nimages;
 ...
 %%%%%%%%%%%% Load the Histograms %%%%%%%%%%%%%
     ...
     %      histogram=[(2.96).*histogram2;(0.04).*histogram1];
% histogram=[(1.96).*histogram2;(0.05).*histogram1];
% histogram=[(7.9).*histogram2;(0.1).*histogram1];
% histogram=[(0.5).*histogram2;(0.5).*histogram1];
% histogram=[histogram2;histogram1;histogram3;histogram4;histogram5];
...
% save -v7.3 '/home/cic/fahad/Datasets/FMD/Data/split1/Fusion/dec_values_ColorNM' dec_values
save -v7.3 '/home/cic/fahad/Datasets/FMD/Data/split1/Fusion/dec_values_Rebuttal' dec_values
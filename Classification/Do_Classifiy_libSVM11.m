function [svm_score,best_CV]=Do_Classifiy_libSVM11(opts,classification_opts)
...
%           histogram=[(0.89).*histogram1;(0.4).*histogram2;(0.2).*histogram3];
%           histogram=[(0.5).*histogram1;(0.42).*histogram2;(0.15).*histogram3];
%%%% This one 
...
% histogram=[(0.35).*histogram1;(0.62).*histogram2;(0.2).*histogram3;(0.1).*histogram4]; 
...
%               [predict_labels,svm_score,dec_values]=Do_libSVM(histogram_train',histogram_test',train_truth,test_truth,best_C);
    ...
    [predict_labels,accuracy, dec_values]=Do_libSVM_chi(histogram_train',histogram_test',train_truth,test_truth,best_C,best_G); 
accuracy
pause
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%               
                ...
                %        save -v7.3 '/home/fahad/Datasets/flower/Data/Global/predict_labels_LLC' predict_labels
%         save -v7.3 '/home/fahad/Datasets/flower/Data/Global/dec_values_LLC' dec_values

%          save -v7.3 '/home/fahad/Datasets/Butterflies/Data/Global/predict_labels_Pall' predict_labels
%           save -v7.3 '/home/fahad/Datasets/Butterflies/Data/Global/dec_values_pall' dec_values

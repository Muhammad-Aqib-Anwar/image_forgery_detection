...
%  nimages=opts.nimages;
 ...
 %%%%%%%%%%%% Load the Histograms %%%%%%%%%%%%%
%[opts.data_assignmentpath,'/',classification_opts.assignment_name]
%display('hist name displayed')
...
%best_C=20; best_CV=0;
[best_C,best_CV]=Do_CV_libSVM_ikmmulti_noha(histogram_train',train_truth) ;  

function [svm_score,best_CV]=Do_Classifiy_libSVM_pascal2007_overfeat(opts,classification_opts,rng)
...
% histogram1=getfield(load([opts.data_assignmentpath,'/',classification_opts.assignment_name]),'X');
% histogram1=histogram1';

histogram2=getfield(load([opts.data_assignmentpath,'/',classification_opts.assignment_name2]),'All_hist');
% histogram2=histogram2';

% histogram3=getfield(load([opts.data_assignmentpath,'/',classification_opts.assignment_name3]),'X');
...
%            size(histogram)
histogram=[normalize(histogram1,1);normalize(histogram2,1);normalize(histogram3,1)];
...
% histogram=[(0.9).*histogram1;(0.1).*histogram2;(0.2).*histogram3];
%               sum(sum(histogram,1)==0)
%           pause

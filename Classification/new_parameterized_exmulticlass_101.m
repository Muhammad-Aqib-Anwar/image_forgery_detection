...
% [all_histL,all_hist_C,alpha3]=learn_alpha(all_histL,all_hist_C,c,lambda,yapp,nbclass,kernel,kerneloption,verbose,start_row(1),end_row(3),start_row(4),end_row(4) );
% [all_histL,all_hist_C,alpha3]=learn_alpha(all_histL,all_hist_C,c,lambda,yapp,nbclass,kernel,kerneloption,verbose,start_row(1),end_row(4),start_row(5),end_row(5) );
end         
%%%%%%%%%%%%%%%%%%%%%%%%%%%

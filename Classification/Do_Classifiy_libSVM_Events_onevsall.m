function [svm_score,best_CV]=Do_Classifiy_libSVM_Events_onevsall(opts,classification_opts)
...
histogram=sqrt(histogram);
  acc_class=[];
for i=1:nclasses
%     filename1=sprintf('/home/fahad/Datasets/event_dataset//Data//Global//Assignment//diffusionmaps_ikmeansSIFT_DorkoGrid5000_fastkmeansColorNMGrid100_PCX_500_fastkmeansColorNMGrid100_try21_Beta_Class%d.mat',i);
%     load(filename1,'All_hist')
%     histogram=sqrt(All_hist);
...
% save -v7.3 '/home/cic/fahad/Datasets/event_dataset/Fusion/dec_values_CNSIFT_1k_CSP1' dec_values
% save -v7.3 '/home/cic/fahad/Datasets/event_dataset/Fusion/dec_values_LBP_1k_P3' dec_values

save -v7.3 '/home/cic/fahad/Datasets/event_dataset/Fusion/dec_values_LFCNLBP_1k_P3' dec_values

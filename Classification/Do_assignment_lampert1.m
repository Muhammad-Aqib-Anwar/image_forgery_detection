function []=Do_assignment_lampert1(opts,assignment_opts)
...
%       index_list2=getfield(load([opts.data_assignmentpath,'/','KmeansColorNMGrid_Dorko500_hybrid_index']),'index_list');
          index_list=getfield(load([opts.data_assignmentpath,'/','ikmeansSIFT_DorkoGrid_Dorko_ColorNMGrid_Dorko_12000_EF_aib4000_hybrid_index']),'index_list');
      assignment_opts.name='ikmeansSIFT_DorkoGrid_Dorko_ColorNMGrid_Dorko_12000_EF_aib4000';
          for i=1:nimages
...
%%%%%%%%%%%%%%%%% extract all 3 detector types points %%%%%%%%%%%%%%%%%%%%
                ...
                points_out_har=load([data_locations{i},'/',assignment_opts.detector_name]);

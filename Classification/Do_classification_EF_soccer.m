...
%  All_hist=[all_hist1(:,1:25),all_hist1(:,41:65),all_hist1(:,81:105),all_hist1(:,121:145),all_hist1(:,161:185),all_hist1(:,201:225),all_hist1(:,241:265),all_hist1(:,281:305),all_hist1(:,321:345),all_hist1(:,361:385)];
 All_hist=[all_hist1(:,1:25),all_hist1(:,41:65),all_hist1(:,81:105),all_hist1(:,121:145),all_hist1(:,161:185),all_hist1(:,201:225),all_hist1(:,241:265)];
all_hist_C=All_hist;
numVOC=1;
% start_row=[1,601];
%  end_row=[600,650];
...
% % list=1:perclass_image;
%         all_histL=[];
% for jj=1:nbclass
%              all_histL=[all_histL;all_hist_C(:,list(1:N)+(jj-1)*perclass_image)'];
% end
               [c,lambda,svm_score]=cross_validate(all_hist_C',yapp,nbclass,kernel,kerneloption,verbose);
               svm_score/5
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
%  for N=20:20;                   % number of test images

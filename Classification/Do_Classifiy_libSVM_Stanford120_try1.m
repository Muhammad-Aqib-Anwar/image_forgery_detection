function [svm_score,best_CV]=Do_Classifiy_libSVM_Stanford120_try1(opts,classification_opts)
...
%  nimages=opts.nimages;
 ...
 %%%%%%%%%%%% Load the Histograms %%%%%%%%%%%%%
 load('/home/cic/fahad/Datasets/Stanford_Dogs/Data/Global/Assignment/train_data.mat');
 load('/home/cic/fahad/Datasets/Stanford_Dogs/Data/Global/Assignment/test_data.mat');

histogram1=[train_fg_data;test_fg_data];
histogram1=histogram1';
histogram2=getfield(load([opts.data_assignmentpath,'/','fastkmeansColorNM_DITC_R_UnivGrid_Scale_Selection500Marcin3']),'All_hist');     
...
% save -v7.3 '/home/cic/fahad/Datasets/Stanford_Dogs/Fusion/dec_values_PCN_4' dec_values
% save -v7.3 '/home/cic/fahad/Datasets/Stanford_Dogs/Fusion/dec_values_PSIFT_Sqrt' dec_values

% save -v7.3 '/home/cic/fahad/Datasets/Stanford_Dogs/Fusion/dec_values_PCNSIFT_Sqrt_R' dec_values
% save -v7.3 '/home/cic/fahad/Datasets/Stanford_Dogs/Fusion/dec_values_PCN_Sqrt_R' dec_values

% save -v7.3 '/home/cic/fahad/Datasets/Stanford_Dogs/Fusion/dec_values_PCNSIFT_UNIV_Sqrt_R' dec_values
save -v7.3 '/home/cic/fahad/Datasets/Stanford_Dogs/Fusion/dec_values_PCN_UNIV_Sqrt_R' dec_values

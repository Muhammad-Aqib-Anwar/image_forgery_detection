function [net, info] = cnn_imagenet_opp(varargin)
...
opts.dataDir = fullfile('/scratch/cs/imagedb/anwerr1/Datasets/','Imagenet_2012_opp_only') ;
...
opts.expDir = fullfile(expDir,'data', sprintf('Imagenet_2012_opp_only-%s', sfx)) ;

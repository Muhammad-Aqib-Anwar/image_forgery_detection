function imdb = cnn_imagenet_setup_data_depth(varargin)
...
%   ims = dir(fullfile(opts.dataDir, 'images', 'train', d.name, '*.jpg')) ;
  %ims = dir(fullfile(opts.dataDir, 'images', 'train', d.name, '*.png')) ;
  ims = dir(fullfile(opts.dataDir, 'images', 'train', d.name, '*_gray.jpg')) ;
...
ims = dir(fullfile(opts.dataDir, 'images', 'val', '*_gray.jpg')) ;
names = sort({ims.name}) ;
...
ims = dir(fullfile(opts.dataDir, 'images', 'test', '*_gray.jpg')) ;

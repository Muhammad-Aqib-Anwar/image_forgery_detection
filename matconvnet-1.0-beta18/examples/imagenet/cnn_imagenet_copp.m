function [net, info] = cnn_imagenet_copp(varargin)
...
opts.dataDir = fullfile('/scratch/cs/imagedb/anwerr1/Datasets/','Imagenet_2012_copp_only') ;
...
opts.expDir = fullfile(expDir,'data', sprintf('Imagenet_2012_copp_only-%s', sfx)) ;
...
if exist(opts.imdbPath)
  ...
  imdb = cnn_imagenet_setup_data_opp('dataDir', opts.dataDir, 'lite', opts.lite) ;
  mkdir(opts.expDir) ;

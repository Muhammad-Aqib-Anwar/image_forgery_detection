 function run_lucasdigicamident(im)
...
% inPath='/Users/apple/Downloads/data-images/Sony_A57/tampered-realistic';
% inPath = '/Users/apple/Downloads/data-images/all_images/crop_tempered_level4' ;
inPath='/Users/apple/Downloads' ;

% outPath = '/cluster/deka/VISION/References';      % This is where the prnu reference data are saved (.mat file)
% outPath='/Users/apple/Downloads/data-images/Sony_A57/PRNU_t';
% outPath='/Users/apple/Downloads/data-images/all_images/crop_tempered_level4_prnu' ;
outPath='/Users/apple/Downloads' ;
...
% gprnu_size = 7201280;  
gprnu_size = 0;  %  size of the extracted G-PRNU (in px). default 0 to get un-resized GPRNU
                         %  Give interpolation method in the next line if gprnu_size > 0
                         %   ,num2str(gprnu_size),
interpolation_method = 'bilinear'; %bicubic %bilinear  %nearest

cameraID = strcat('D07_',num2str(gprnu_size),'_',interpolation_method);  % Identifier for camera make/model

imageType = 'N1';         % Specify argument as FF for flat-field and NI for natural image
...
iList={im} ;
% iList = {'P1.JPG' 'P2.JPG' 'P3.JPG'};  % Specify image names. If iList is commented out then all images in folder inPath are used
% iList = {'horse_orig.png'};
%  iList = {'Nikon_D7000_2.TIF' , 'Nikon_D7000_3.TIF'};
% iList = {'P_Nikon_D7000_2.TIF' , 'P_Nikon_D7000_3.TIF'};
% addpath '/Users/apple/Downloads/data-images/all_images/crop_tempered_level4'
% load('image_names.mat')
% iList=srcFiles' ;
% iList={'neg11.TIF' ,'neg12.TIF','neg13.TIF','neg14.TIF','neg15.TIF','neg16.TIF','neg17.TIF','neg18.TIF','neg19.TIF','neg20.TIF'} ;
...
inpath = '/Users/apple/Downloads/Forensics-Tool-Hybrid-G-PRNU-Extractor-master' ;

% outPath = 'E:\Reep\PRNU\VISION\References';      % This is where the correlation results file is written
outPath = '/Users/apple/Downloads/Forensics-Tool-Hybrid-G-PRNU-Extractor-master' ;
